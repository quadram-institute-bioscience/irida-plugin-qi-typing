 ...
 */
public class QITypingPlugin extends Plugin {
	 ...
	 * for each pipeline).
	 */
	public static final AnalysisType QI_TYPING = new AnalysisType("QI_TYPING");

	public QITypingPlugin(PluginWrapper wrapper) {
		super(wrapper);
	}
	...
	public static class PluginInfo implements IridaPlugin {
		...
		public UUID getDefaultWorkflowUUID() {
			...
			return UUID.fromString("4ad8ee74-251d-48b5-8b03-fa1dc656e8e7");
		}
		...
		public Optional<AnalysisSampleUpdater> getUpdater(MetadataTemplateService metadataTemplateService,
			...
			return Optional.of(new QITypingPluginUpdater(metadataTemplateService, sampleService, iridaWorkflowsService));
		}
	}
}
